...
Check out the vignette for an exhaustiv step-by-step tutorial where I illustrate how the package works using publicly available data. 
...
* 2 - A bed file listing the genomic coordinates and IDs of all the orthologs of the 1st species (first column of file 1)   
* 3 - A bed file, same as the other, for the 2nd species.
